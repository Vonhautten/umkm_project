...
<div class="container my-4" style="min-height: 80vh;"> <!-- Min height agar footer tidak naik -->
            ...
            <div class="col-md-3 mb-4">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body d-flex flex-column text-center">
                        ...
                        <p class="card-text flex-grow-1">{{ Str::limit($item->deskripsi, 50) }}</p>
                        ...
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            <button 
                                ...
                                data-bs-target="#beliModal{{ $item->id }}">
                                Beli Sekarang
                            </button>
